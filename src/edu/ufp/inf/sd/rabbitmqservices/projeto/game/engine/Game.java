...
public class Game extends JFrame {
	...
	public static List<edu.ufp.inf.sd.rabbitmqservices.projeto.game.players.Base> player = new ArrayList<edu.ufp.inf.sd.rabbitmqservices.projeto.game.players.Base>();
	public static List<edu.ufp.inf.sd.rabbitmqservices.projeto.game.buildings.Base> builds = new ArrayList<edu.ufp.inf.sd.rabbitmqservices.projeto.game.buildings.Base>();
	public static List<edu.ufp.inf.sd.rabbitmqservices.projeto.game.units.Base> units = new ArrayList<edu.ufp.inf.sd.rabbitmqservices.projeto.game.units.Base>();
	//These are the lists that will hold commander, building, and unit data to use in the menu's
	public static List<edu.ufp.inf.sd.rabbitmqservices.projeto.game.players.Base> displayC = new ArrayList<edu.ufp.inf.sd.rabbitmqservices.projeto.game.players.Base>();
	...
	public Game(String mapName, ObserverGuiClient o) {super (name);
		...
		btl.NewGame(mapName);
		btl.AddCommanders(plyer, npc, 100, 50);
		gui.InGameScreen();
		save.LoadSettings();
		GameLoop();
	}
