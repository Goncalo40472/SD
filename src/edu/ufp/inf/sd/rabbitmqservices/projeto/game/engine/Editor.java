...
public class Editor {
	...
	public void StartEditor(String name, int height, int width) {
		...
		Game.player = new ArrayList<edu.ufp.inf.sd.rabbitmqservices.projeto.game.players.Base>();
		Game.builds = new ArrayList<edu.ufp.inf.sd.rabbitmqservices.projeto.game.buildings.Base>();
	...
	public void AssButton() {
		...
		case CITY:
			AddBuilding();
			Game.map.map[selecty][selectx] = new edu.ufp.inf.sd.rabbitmqservices.projeto.game.terrain.City();
		break;
		case UNIT:
	...
	public void ButtButton() {
		new edu.ufp.inf.sd.rabbitmqservices.projeto.game.menus.EditorStuff();
	}
