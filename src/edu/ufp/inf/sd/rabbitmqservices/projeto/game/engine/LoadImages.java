...
public class LoadImages {
	...
	public LoadImages() {
		...
		edu.ufp.inf.sd.rabbitmqservices.projeto.game.engine.Game.img_char = tool.getImage(getClass().getResource("/edu/ufp/inf/sd/rabbitmqservices/projeto/game/img/" + "Units" + ".png"));
		edu.ufp.inf.sd.rabbitmqservices.projeto.game.engine.Game.img_tile = tool.getImage(getClass().getResource("/edu/ufp/inf/sd/rabbitmqservices/projeto/game/img/" + "Terrain" + ".png"));
		edu.ufp.inf.sd.rabbitmqservices.projeto.game.engine.Game.img_city = tool.getImage(getClass().getResource("/edu/ufp/inf/sd/rabbitmqservices/projeto/game/img/" + "Cities" + ".png"));
		edu.ufp.inf.sd.rabbitmqservices.projeto.game.engine.Game.img_exts = tool.getImage(getClass().getResource("/edu/ufp/inf/sd/rabbitmqservices/projeto/game/img/" + "Extras" + ".png"));
		edu.ufp.inf.sd.rabbitmqservices.projeto.game.engine.Game.img_plys = tool.getImage(getClass().getResource("/edu/ufp/inf/sd/rabbitmqservices/projeto/game/img/" + "Players" + ".png"));
		edu.ufp.inf.sd.rabbitmqservices.projeto.game.engine.Game.img_menu[0] = tool.getImage(getClass().getResource("/edu/ufp/inf/sd/rabbitmqservices/projeto/game/img/" + "GameInfo" + ".png"));
	}
