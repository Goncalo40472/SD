...
public class MapParser {
	...
	String path = "C:\\Users\\gonca\\IdeaProjects\\SD\\maps";
	...
	private String encodeCities() {
		...
		if (!Game.builds.isEmpty()) {
			cities+="\n3 ";
			for (edu.ufp.inf.sd.rabbitmqservices.projeto.game.buildings.Base bld : Game.builds) {
	...
	private String encodeUnits() {
		...
		if (!Game.units.isEmpty()) {
			units+="\n5 ";
			for (edu.ufp.inf.sd.rabbitmqservices.projeto.game.units.Base unit : Game.units) {
				units+=UnitID(unit);
	...
	private String CityID(edu.ufp.inf.sd.rabbitmqservices.projeto.game.buildings.Base bld) {
		String a = "00";
	...
	private String UnitID(edu.ufp.inf.sd.rabbitmqservices.projeto.game.units.Base unit) {
		String a = "00";
	...
	private List<edu.ufp.inf.sd.rabbitmqservices.projeto.game.buildings.Base> FormatCities(List<edu.ufp.inf.sd.rabbitmqservices.projeto.game.buildings.Base> oldblds) {
		List<edu.ufp.inf.sd.rabbitmqservices.projeto.game.buildings.Base> newblds = new ArrayList<edu.ufp.inf.sd.rabbitmqservices.projeto.game.buildings.Base>();
