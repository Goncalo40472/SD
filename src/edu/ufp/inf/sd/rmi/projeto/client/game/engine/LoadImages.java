...
public class LoadImages {
	...
	public LoadImages() {
		...
		Game.img_char = tool.getImage(getClass().getResource("/edu/ufp/inf/sd/rmi/projeto/client/game/img/" + "Units" + ".png"));
		Game.img_tile = tool.getImage(getClass().getResource("/edu/ufp/inf/sd/rmi/projeto/client/game/img/" + "Terrain" + ".png"));
		Game.img_city = tool.getImage(getClass().getResource("/edu/ufp/inf/sd/rmi/projeto/client/game/img/" + "Cities" + ".png"));
		Game.img_exts = tool.getImage(getClass().getResource("/edu/ufp/inf/sd/rmi/projeto/client/game/img/" + "Extras" + ".png"));
		Game.img_plys = tool.getImage(getClass().getResource("/edu/ufp/inf/sd/rmi/projeto/client/game/img/" + "Players" + ".png"));
		Game.img_menu[0] = tool.getImage(getClass().getResource("/edu/ufp/inf/sd/rmi/projeto/client/game/img/" + "GameInfo" + ".png"));
	}
