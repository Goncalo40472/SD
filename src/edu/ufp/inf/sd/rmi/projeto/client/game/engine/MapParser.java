...
public class MapParser {
	...
	private String encodeUnits() {
		...
		if (!Game.units.isEmpty()) {
			units+="\n5 ";
			for (edu.ufp.inf.sd.rmi.projeto.client.game.units.Base unit : Game.units) {
				units+=UnitID(unit);
	...
	private String CityID(edu.ufp.inf.sd.rmi.projeto.client.game.buildings.Base bld) {
		String a = "00";
	...
	private String UnitID(edu.ufp.inf.sd.rmi.projeto.client.game.units.Base unit) {
		String a = "00";
	...
	private List<edu.ufp.inf.sd.rmi.projeto.client.game.buildings.Base> FormatCities(List<edu.ufp.inf.sd.rmi.projeto.client.game.buildings.Base> oldblds) {
		List<edu.ufp.inf.sd.rmi.projeto.client.game.buildings.Base> newblds = new ArrayList<edu.ufp.inf.sd.rmi.projeto.client.game.buildings.Base>();
