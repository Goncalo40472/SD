...
import edu.ufp.inf.sd.rmi.projeto.client.game.buildings.Base;
...
public class SmallMenu {
	public static void Draw(Graphics2D g, int resize) {
		...
		edu.ufp.inf.sd.rmi.projeto.client.game.players.Base ply = Game.player.get(Game.btl.currentplayer);
